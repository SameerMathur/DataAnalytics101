...
ggplot(data = tb,  # Specify the data frame 'tb'
  ...
  geom_bar(aes(fill = cyl)) +  # Create a bar graph, 'fill' colors bars based on 'cyl' values
...
```{r}
ggplot(data = tb, aes(x = cyl)) + # Initialize ggplot with 'tb' data, setting 'cyl' as the x-axis
  geom_bar(aes(fill = cyl)) + # Add bar geometries, filling bars based on 'cyl' values
  geom_text(stat='count',    # Add text labels on bars using the 'count' statistic
            aes(label=after_stat(count)), # 'label' is set to display the count
            vjust=-0.5) + # Adjust vertical position of labels to be above the bars
...
## Summary of Chapter 7 -- Categorical Data
...
A Guide on Data Analysis. (n.d.). Categorical Data Analysis. Retrieved from https://bookdown.org/content/4861/categorical-data-analysis.html
...
\[3\] Friendly, M., & Meyer, D. (2016). Discrete Data Analysis with R: Visualization and Modeling Techniques for Categorical and Count Data. Chapman and Hall/CRC.

Wickham, H., & Grolemund, G. (2016). R for Data Science: Import, Tidy, Transform, Visualize, and Model Data. O'Reilly Media.

Crawley, M. J. (2007). The R Book. Wiley.

\[4\] Healy, K., & Lenard, M. T. (2014). A practical guide to creating better looking plots in R. University of Oregon. https://escholarship.org/uc/item/07m6r
