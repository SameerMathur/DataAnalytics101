...
**Chapter 5, *Last updated: Jan 1, 2023.***
...
Next, we will understand R code to explore a dataframe, step-by-step. \[2\]
...
1.  `$`: In R, the dollar sign `$` is a unique operator that lets us retrieve specific columns from a dataframe or elements from a list. \[2\]
...
1.  `str()`: This function displays the internal structure of an R object. \[2\]
...
-   `mean()`: This function computes the arithmetic mean. \[5\]
...
-   `var()`': This function computes the variance. \[5\]
...
1.  `summary()`: This function is a convenient tool to generate basic descriptive statistics for your dataset. It provides a succinct snapshot of the distribution characteristics of your data. \[5\]
...
-   We illustrate how to create a custom function in R that computes the mean of any given numeric column in the mtcars dataframe \[6\]
...
\[2\] W3Schools. (n.d.). R Data Frames. Retrieved from [https://www.w3schools.com](https://www.w3schools.com/)

RDocumentation. (n.d.). data.frame function. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

Programiz. (n.d.). R Data Frame (with Examples). Retrieved from [https://www.programiz.com](https://www.programiz.com/)

Dataquest. (2023). How to Create a Dataframe in R with 30 Code Examples. Retrieved from [https://www.dataquest.io](https://www.dataquest.io/)

\[3\] University of California, Berkeley. (n.d.). *Factors in R*. Retrieved from https://www.stat.berkeley.edu/\~s133/factors.html

Wickham, H., & Grolemund, G. (n.d.). *R for Data Science*. Retrieved from <https://r4ds.had.co.nz/factors.html>

\[4\] R Core Team. (n.d.). *subset: Subsetting Vectors, Matrices, and Data Frames*. RDocumentation. Retrieved from <https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/subset>

R Core Team. (n.d.). *ifelse: Conditional Element Selection*. RDocumentation. Retrieved from https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/ifelse

\[5\] R Core Team. (n.d.). *mean: Arithmetic Mean*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

R Core Team. (n.d.). *median: Median Value*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

R Core Team. (n.d.). *sd: Standard Deviation*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

R Core Team. (n.d.). *var: Variance*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

R Core Team. (n.d.). *cor: Correlation*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

\[5\] R Core Team. (n.d.). *summary: Object Summaries*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)

\[6\] R Core Team. (n.d.). *function: Function Definition*. RDocumentation. Retrieved from [https://www.rdocumentation.org](https://www.rdocumentation.org/)
