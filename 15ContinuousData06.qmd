...
```{r}
# Load the 'ggpubr' library, which contains the 'ggscatter()' function
library(ggpubr)
...
ggscatter(data = tb, x = "hp", y = "mpg", color = "mpg") + 
  gradient_color(c("blue", "gray", "red")) # Add a gradient color scheme
```
...
## Summary of Chapter 15 -- Continuous x Continuous data (2 of 2)
