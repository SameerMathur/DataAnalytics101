...
#### Chapter 14, *Last updated: **Jan 03, 2024***
...
plot(wt, 
     mpg, 
     main = "Scatter Plot of Mileage vs. Weight", # Set the title of the plot
...
plot(tb$wt, 
     ...
     pch = 16,  # Use filled circles as data points
     col = c("red", "green", "blue")[tb$cyl]  # Color points on cylinders (cyl)
     )
...
## Summary of Chapter 14 -- Continuous x Continous data (1 of 2)
...
\[3\] Fox, J. and Weisberg, S. (2011). An R Companion to Applied Regression, Second Edition. Thousand Oaks CA: Sage.

**car**

\[4\] Fox, J., Weisberg, S., Adler, D., Bates, D., Baud-Bovy, G., Ellison, S., \... & Heiberger, R. (2012). Package \'car\'. *Vienna: R Foundation for Statistical Computing*, *16*.
...
\[6\] Schloerke, B., Crowley, J., & Cook, D. (2018). Package \'GGally\'. *Extension to \'ggplot2*, *713*.
